/**
 * Lezer-based grammar definition and syntax highlighting configuration for CSP language.
  ...
  parser: parser.configure({
    props: [
      styleTags({
        ...
        'IF ELSE REPEAT UNTIL TIMES FOR EACH IN PROCEDURE RETURN DISPLAY INPUT CLASS CONSTRUCTOR EXTENDS NEW PUBLIC PRIVATE THIS':
          t.keyword,
