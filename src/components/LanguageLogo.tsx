...
function CspLogo({ size }: { size: number }) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 32 32">
      <path
        d="M16 30c-5.5 0-9-4.2-9-9.5 0-4.6 3.1-8.7 9-8.7s9 4.1 9 8.7c0 5.3-3.5 9.5-9 9.5z"
        fill="currentColor"
      />
      <path
        d="M6.2 13.8c0-3.6 4.4-6.3 9.8-6.3s9.8 2.7 9.8 6.3c0 1-.6 1.7-1.6 1.9-2.4.5-5.3-1-8.2-1s-5.8 1.5-8.2 1c-1-.2-1.6-.9-1.6-1.9z"
        fill="currentColor"
      />
      <path
        d="M9.5 11.2c2 .6 4.2.9 6.5.9s4.5-.3 6.5-.9M9.9 9.4c1.9.5 3.9.8 6.1.8s4.2-.3 6.1-.8"
        stroke="currentColor"
        strokeWidth="1"
        strokeLinecap="round"
        fill="none"
        opacity="0.55"
      />
      <path d="M17.5 7.4c.6-1.8 2.3-2.9 4-2.6-.4 1.7-1.9 2.9-3.6 2.9" fill="currentColor" />
    </svg>
  );
}
